...
discrVsPt_b_AK4_2021    = inputFile_AK4_2021.Get('bTaggingExerciseIIAK4Jets/' + bTagger1 + '_b')
discrVsPt_c_AK4_2021 = inputFile_AK4_2021.Get('bTaggingExerciseIIAK4Jets/' + bTagger1 + '_c')
discrVsPt_udsg_AK4_2021 = inputFile_AK4_2021.Get('bTaggingExerciseIIAK4Jets/' + bTagger1 + '_udsg')

discrVsPt_b_AK4_2023    = inputFile_AK4_2023.Get('bTaggingExerciseIIAK4Jets/' + bTagger1 + '_b')
discrVsPt_c_AK4_2023 = inputFile_AK4_2023.Get('bTaggingExerciseIIAK4Jets/' + bTagger1 + '_c')
discrVsPt_udsg_AK4_2023 = inputFile_AK4_2023.Get('bTaggingExerciseIIAK4Jets/' + bTagger1 + '_udsg')

discrVsPt_b_AK4_2024    = inputFile_AK4_2024.Get('bTaggingExerciseIIAK4Jets/' + bTagger1 + '_b')
discrVsPt_c_AK4_2024 = inputFile_AK4_2024.Get('bTaggingExerciseIIAK4Jets/' + bTagger1 + '_c')
discrVsPt_udsg_AK4_2024 = inputFile_AK4_2024.Get('bTaggingExerciseIIAK4Jets/' + bTagger1 + '_udsg')
...
c.cd(1)
#c.SetLogx()
tagged_b_AK4_2024_L.Rebin(50)
tagged_b_AK4_2024_M.Rebin(50)
tagged_b_AK4_2024_T.Rebin(50)
total_b_AK4_2024.Rebin(50)

tagged_b_AK4_2021_L.Rebin(50)
tagged_b_AK4_2021_M.Rebin(50)
tagged_b_AK4_2021_T.Rebin(50)
total_b_AK4_2021.Rebin(50)

tagged_b_AK4_2023_L.Rebin(50)
tagged_b_AK4_2023_M.Rebin(50)
tagged_b_AK4_2023_T.Rebin(50)
total_b_AK4_2023.Rebin(50)

# b jets

eff_b_AK4_2021_L = TGraphAsymmErrors(tagged_b_AK4_2021_L, total_b_AK4_2021, "cp")
eff_b_AK4_2021_L.GetXaxis().SetTitle("Jet p_{T} [GeV]")
eff_b_AK4_2021_L.GetYaxis().SetTitle("b-tagging efficiency")
eff_b_AK4_2021_L.GetXaxis().SetRangeUser(20.,1000.)
...
c.cd(2)
#c.SetLogx()
tagged_udsg_AK4_2024_L.Rebin(50)
tagged_udsg_AK4_2024_M.Rebin(50)
tagged_udsg_AK4_2024_T.Rebin(50)
total_udsg_AK4_2024.Rebin(50)

tagged_udsg_AK4_2021_L.Rebin(50)
tagged_udsg_AK4_2021_M.Rebin(50)
tagged_udsg_AK4_2021_T.Rebin(50)
total_udsg_AK4_2021.Rebin(50)

tagged_udsg_AK4_2023_L.Rebin(50)
tagged_udsg_AK4_2023_M.Rebin(50)
tagged_udsg_AK4_2023_T.Rebin(50)
total_udsg_AK4_2023.Rebin(50)


eff_udsg_AK4_2021_L = TGraphAsymmErrors(tagged_udsg_AK4_2021_L, total_udsg_AK4_2021, "cp")
eff_udsg_AK4_2021_L.GetXaxis().SetTitle("Jet p_{T} [GeV]")
eff_udsg_AK4_2021_L.GetYaxis().SetTitle("light-mistag efficiency")
eff_udsg_AK4_2021_L.GetXaxis().SetRangeUser(20.,1000.)
...
c.cd(3)
#c.SetLogx()
tagged_c_AK4_2024_L.Rebin(50)
tagged_c_AK4_2024_M.Rebin(50)
tagged_c_AK4_2024_T.Rebin(50)
total_c_AK4_2024.Rebin(50)

tagged_c_AK4_2021_L.Rebin(50)
tagged_c_AK4_2021_M.Rebin(50)
tagged_c_AK4_2021_T.Rebin(50)
total_c_AK4_2021.Rebin(50)

tagged_c_AK4_2023_L.Rebin(50)
tagged_c_AK4_2023_M.Rebin(50)
tagged_c_AK4_2023_T.Rebin(50)
total_c_AK4_2023.Rebin(50)


eff_c_AK4_2021_L = TGraphAsymmErrors(tagged_c_AK4_2021_L, total_c_AK4_2021, "cp")
eff_c_AK4_2021_L.GetXaxis().SetTitle("Jet p_{T} [GeV]")
eff_c_AK4_2021_L.GetYaxis().SetTitle("c-mistag efficiency")
eff_c_AK4_2021_L.GetXaxis().SetRangeUser(20.,1000.)
...
# save the plot
c.SaveAs('Efficiency_vs_pT.root')
