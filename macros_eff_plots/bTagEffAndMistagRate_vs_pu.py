...
discrVsPt_b_AK4_2021    = inputFile_AK4_2021.Get('bTaggingExerciseIIAK4Jets/' + bTagger1 + '_b_pu')
discrVsPt_c_AK4_2021 = inputFile_AK4_2021.Get('bTaggingExerciseIIAK4Jets/' + bTagger1 + '_c_pu')
discrVsPt_udsg_AK4_2021 = inputFile_AK4_2021.Get('bTaggingExerciseIIAK4Jets/' + bTagger1 + '_udsg_pu')

discrVsPt_b_AK4_2023    = inputFile_AK4_2023.Get('bTaggingExerciseIIAK4Jets/' + bTagger1 + '_b_pu')
discrVsPt_c_AK4_2023 = inputFile_AK4_2023.Get('bTaggingExerciseIIAK4Jets/' + bTagger1 + '_c_pu')
discrVsPt_udsg_AK4_2023 = inputFile_AK4_2023.Get('bTaggingExerciseIIAK4Jets/' + bTagger1 + '_udsg_pu')

discrVsPt_b_AK4_2024    = inputFile_AK4_2024.Get('bTaggingExerciseIIAK4Jets/' + bTagger1 + '_b_pu')
discrVsPt_c_AK4_2024 = inputFile_AK4_2024.Get('bTaggingExerciseIIAK4Jets/' + bTagger1 + '_c_pu')
discrVsPt_udsg_AK4_2024 = inputFile_AK4_2024.Get('bTaggingExerciseIIAK4Jets/' + bTagger1 + '_udsg_pu')
...
eff_b_AK4_2021_L.GetXaxis().SetTitle("npu")
eff_b_AK4_2021_L.GetYaxis().SetTitle("b-tagging efficiency")
eff_b_AK4_2021_L.GetXaxis().SetRangeUser(50, 80)
...
eff_udsg_AK4_2021_L.GetXaxis().SetTitle("npu")
eff_udsg_AK4_2021_L.GetYaxis().SetTitle("light-mistag efficiency")
eff_udsg_AK4_2021_L.GetXaxis().SetRangeUser(50, 80)
...
eff_c_AK4_2021_L.GetXaxis().SetTitle("npu")
eff_c_AK4_2021_L.GetYaxis().SetTitle("c-mistag efficiency")
eff_c_AK4_2021_L.GetXaxis().SetRangeUser(50, 80)
...
# save the plot
c.SaveAs('Efficiency_vs_pu.root')
